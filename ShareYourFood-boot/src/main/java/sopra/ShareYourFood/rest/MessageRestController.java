...
public class MessageRestController {
	...
	@GetMapping("/dernier-message-demandeur/{id}")
	@JsonView(Views.ViewMessage.class)
	@PreAuthorize("hasRole('DONNEUR')")
	public Message findDernierMessageByDemandeur(@PathVariable Long id) {
		return messageRepo.findDernierMessageDemandeurByDemandeId(id);
	}
